...
public class RDBMSDumperTopology {
		...
		public static void main(String[] args) throws SQLException {
			...
			String rdbmsUrl = "jdbc:postgresql://localhost:5432/tests" ;
			...
			RDBMSDumperBolt dumperBolt = new RDBMSDumperBolt(primaryKey, tableName, columnNames, columnTypes, rdbmsUrl);
